...
| reddit.com | Web Unlocker | **refused** (robots.txt) |
| youtube.com | Web Unlocker | **refused** (robots.txt) |
...
- **The X data is reach, not sentiment.** The X Posts dataset returns engagement counts and not
  tone, and it discovers by profile rather than by keyword.
